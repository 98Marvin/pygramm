...
<head>
  ...
  <!-- FAVICON -->
  <link href="/back/assets/assets/img/favicon.png" rel="shortcut icon" />
  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Pygramm Login</span>
                </a>
              </div>
            </div>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2023 Copyright Pygramm Technologies
          <a class="text-primary" href="https://pygrammtech.co.ke" target="_blank">Marvin Wanyama</a>.
        </p>
      </div>
    </div>
</body>
